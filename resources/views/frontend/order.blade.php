                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <div id="inputContainer2">
                                            <div class="d-flex align-items-center input-container2">
                                                <div class="col-md-8">
                                                    <input type="text" class="form-control" placeholder="Enter Measurement Taker Name 1" name="mtaker[]" id="mtaker" required>
                                                </div>
                                                <div class="col-md-3 ms-3">
                                                    <input type="date" class="form-control" name="mdatetime[]" id="mdatetime" required>
                                                </div>
