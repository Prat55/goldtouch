                                        ...
                                        <div class="col-xl-12 col-sm-12">
                                            <div class="row text-black text-start mt-4 chart-link">
                                                <span class="mb-2 col-6">
                                                    <svg class="me-2" width="19" height="19"
                                                ...
                                                <span class="mb-2 col-6">
                                                    <svg class="me-1" width="19" height="19"
                                                        viewbox="0 0 19 19" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <rect width="19" height="19" rx="9.5"
                                                            fill="#FF7A30"></rect>
                            ...
                            <div class="card" id="responsive-map">
                                ...
                                <div class="card-body">
                                    <div class="property-map">
                                        <div id="smallimap" class="smallipop smallipopTour" data-container=".card-body">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-body pb-3">
                                    <p class="mb-2 d-flex fs-16 text-black font-w500">
                                        Product Viewed
                                    ...
                                    <div class="progress mb-4" style="height: 18px">
                                        <div class="progress-bar bg-primary progress-animated"
                                            style="width: 60%; height: 18px" role="progressbar">
                                    ...
                                    <div class="progress mb-3" style="height: 18px">
                                        <div class="progress-bar bg-primary progress-animated"
                                            style="width: 90%; height: 18px" role="progressbar">
                                    ...
                                    <div class="progress mb-3" style="height: 18px">
                                        <div class="progress-bar bg-primary progress-animated"
                                            style="width: 50%; height: 18px" role="progressbar">
                                ...
                                <div class="card-body pb-0">
                                    <div class="pb-3 border-bottom mb-3">
                                        <div class="d-flex mb-3 flex-wrap align-items-end">
                                            <img class="rounded me-3" src="images/contacts/pic11.jpg" width="40"
                                                alt="" />
                                            <div>
                                                <h6 class="fs-16 text-black font-w500 mb-0">
                                                    Hawkins Maru
                                                </h6>
                                    ...
                                    <div class="pb-3 border-bottom mb-3">
                                        ...
                                        <p class="fs-14 mb-0">
                                            ...
                                            surpassed my expectations - they were not only helpful
                                            but extremely approachable and not at all bumptious...
                                        </p>
                                    </div>
                                    <div class="pb-3 border-bottom mb-3">
                                        <div class="d-flex mb-3 flex-wrap align-items-end">
                                        ...
                                        <p class="fs-14 mb-0">
                                            ...
                                            for moving us from Jakarta to Medan during the
                                            lockdown.
                                        </p>
                                    </div>
                                </div>
