...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" href="{{ asset('user-assets/xhtml/images/logo/GT Logo.svg') }}" />
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="{{ route('dashboard') }}" class="brand-logo">
                <img src="{{ asset('user-assets/xhtml/images/logo/GT Logo.svg') }}" alt="brand logo" width="50"
                    height="50">
            </a>
